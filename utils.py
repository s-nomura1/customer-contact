...
# 【問題1】Start all_doc_chain関数の追加
def run_all_doc_chain(param):
    """
    会社、サービス、顧客とのやりとりに関するデータ参照に特化したTool設定用の関数
    ...
    Returns:
        LLMからの回答
    """
    # 会社、サービス、顧客とのやりとりに関するデータ参照に特化したChainを実行してLLMからの回答取得
