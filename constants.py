...
# 【問題1】Start all_doc_chain関数を使ったToolの追加
SEARCH_ALL_INFO_TOOL_NAME = "search_all_tool"
SEARCH_ALL_INFO_TOOL_DESCRIPTION = "会社、サービス、顧客とのやりとりに関する情報をまとめて参照したい時に使う"
# 【問題1】End all_doc_chain関数を使ったToolの追加
...
SYSTEM_PROMPT_NOTICE_SLACK = """
    ...
    - 【メンション先の選定理由】は、選定した担当者が問い合わせ内容に関連していると判断した理由を生成してください。
